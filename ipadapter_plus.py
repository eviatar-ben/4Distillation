...
from ip_adapter.ip_adapter_diffusers import IPAdapter
...
vae = AutoencoderKL.from_pretrained(model, subfolder="vae", revision=None)
...
"""
prompt_embeds, negative_prompt_embeds = ip_adapter.get_prompt_embeds(image1,
